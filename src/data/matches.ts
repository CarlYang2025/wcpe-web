...
export const modelState: ModelState = {
  ...
  totalPredictions: 28,
  completedPredictions: 24,
  directionCorrect: 13,
  scoreTop3Correct: 7,
  scoreTop1Correct: 4,
  overallDrawRate: 0.306,
  overallTotalMatches: 40,
  factorWeights: {
...
export const keyLearnings = [
  '首轮平局率9/24=38%，第二轮平局率3/12=25%（持续下降，回归常态）',
  '强队赔率<1.50时平局溢价1.4x仍有效（西班牙、巴西、比利时、葡萄牙均平局）',
  '6/20四场全部分出胜负，6/21四场3胜1平，第二轮非平局趋势延续（11/12=91.7%非平局）',
  '首轮惨败队伍第二轮反弹严重低估：巴拉圭1:4→1:0土耳其，需新增士气逆转因子',
  '累计方向13/24=54.2%，赛后复盘推进中',
