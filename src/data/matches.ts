...
export const modelState: ModelState = {
  ...
  scoreTop3Accuracy: 0.35,
  scoreTop1Accuracy: 0.25,
  totalPredictions: 24,
  completedPredictions: 20,
  directionCorrect: 10,
  scoreTop3Correct: 7,
  scoreTop1Correct: 5,
  overallDrawRate: 0.333,
  overallTotalMatches: 36,
  factorWeights: {
    eloDiff: { hitRate: 0.50, weight: 0.30, samples: 24 },
    recentForm: { hitRate: 0.38, weight: 0.20, samples: 24 },
    h2h: { hitRate: 0.46, weight: 0.15, samples: 24 },
    marketConsensus: { hitRate: 0.58, weight: 0.25, samples: 24 },
    tacticalMatchup: { hitRate: 0.33, weight: 0.10, samples: 24 },
  },
};

// ========== 球队评分 ==========
export const teamRatings: Record<string, TeamRatings> = {
  'Spain': { attack: 88, defense: 85, form: 82, tournament: 90, elo: 1840 },
  'Cape Verde': { attack: 35, defense: 55, form: 48, tournament: 30, elo: 1450 },
  'Belgium': { attack: 82, defense: 76, form: 80, tournament: 78, elo: 1900 },
  ...
  'France': { attack: 90, defense: 84, form: 82, tournament: 92, elo: 1880 },
  ...
  'Argentina': { attack: 92, defense: 88, form: 95, tournament: 95, elo: 1920 },
  'Algeria': { attack: 68, defense: 65, form: 62, tournament: 58, elo: 1640 },
  'Austria': { attack: 75, defense: 78, form: 80, tournament: 65, elo: 1790 },
  'Jordan': { attack: 40, defense: 48, form: 38, tournament: 30, elo: 1410 },
  'Portugal': { attack: 87, defense: 83, form: 80, tournament: 85, elo: 1970 },
  'DR Congo': { attack: 55, defense: 62, form: 50, tournament: 35, elo: 1590 },
  'England': { attack: 85, defense: 82, form: 78, tournament: 80, elo: 1850 },
  'Croatia': { attack: 72, defense: 75, form: 65, tournament: 78, elo: 1800 },
  'Ghana': { attack: 62, defense: 58, form: 35, tournament: 60, elo: 1620 },
  'Panama': { attack: 58, defense: 62, form: 55, tournament: 40, elo: 1570 },
  'Colombia': { attack: 80, defense: 76, form: 75, tournament: 78, elo: 1860 },
  'Uzbekistan': { attack: 58, defense: 65, form: 55, tournament: 40, elo: 1590 },
  // ---- 补充 24 支缺失评分 ----
  'Brazil': { attack: 88, defense: 82, form: 85, tournament: 88, elo: 1873 },
  'Germany': { attack: 82, defense: 78, form: 75, tournament: 82, elo: 1840 },
  'Netherlands': { attack: 78, defense: 80, form: 76, tournament: 75, elo: 1780 },
  'Mexico': { attack: 72, defense: 70, form: 68, tournament: 72, elo: 1820 },
  'Japan': { attack: 70, defense: 72, form: 72, tournament: 68, elo: 1750 },
  'Switzerland': { attack: 68, defense: 75, form: 70, tournament: 68, elo: 1820 },
  'USA': { attack: 72, defense: 68, form: 70, tournament: 68, elo: 1760 },
  'Morocco': { attack: 70, defense: 75, form: 68, tournament: 72, elo: 1780 },
  'Sweden': { attack: 72, defense: 72, form: 70, tournament: 65, elo: 1730 },
  'South Korea': { attack: 68, defense: 65, form: 66, tournament: 62, elo: 1710 },
  'Ivory Coast': { attack: 72, defense: 65, form: 68, tournament: 62, elo: 1690 },
  'Turkiye': { attack: 68, defense: 62, form: 62, tournament: 60, elo: 1680 },
  'Czechia': { attack: 62, defense: 65, form: 60, tournament: 58, elo: 1690 },
  'Scotland': { attack: 60, defense: 62, form: 58, tournament: 52, elo: 1670 },
  'Ecuador': { attack: 65, defense: 65, form: 62, tournament: 58, elo: 1700 },
  'Canada': { attack: 66, defense: 62, form: 65, tournament: 55, elo: 1790 },
  'Paraguay': { attack: 60, defense: 68, form: 58, tournament: 55, elo: 1680 },
  'Australia': { attack: 65, defense: 68, form: 62, tournament: 60, elo: 1640 },
  'Tunisia': { attack: 58, defense: 62, form: 55, tournament: 52, elo: 1600 },
  'Bosnia': { attack: 58, defense: 55, form: 52, tournament: 48, elo: 1580 },
  'Qatar': { attack: 52, defense: 50, form: 48, tournament: 45, elo: 1500 },
  'South Africa': { attack: 50, defense: 52, form: 45, tournament: 42, elo: 1530 },
  'Haiti': { attack: 45, defense: 42, form: 40, tournament: 30, elo: 1460 },
  'Curacao': { attack: 40, defense: 38, form: 38, tournament: 25, elo: 1420 },
};
...
export const matches: Match[] = [
  ...
  // ---- 6/20 第二轮（北京时间）----
  { id: 'usa-aus-2', date: '2026-06-20', tournament: '2026 FIFA World Cup', group: 'D组', round: '第二轮', matchday: 8, homeTeam: 'USA', awayTeam: 'Australia', venue: 'Lumen Field, Seattle', kickoff: '6/20 03:00', localKickoff: '6/19 12:00', localTZ: 'PT', status: 'finished', homeScore: 2, awayScore: 0 },
  { id: 'sco-mar-2', date: '2026-06-20', tournament: '2026 FIFA World Cup', group: 'C组', round: '第二轮', matchday: 8, homeTeam: 'Scotland', awayTeam: 'Morocco', venue: 'Gillette Stadium, Boston', kickoff: '6/20 03:00', localKickoff: '6/19 15:00', localTZ: 'ET', status: 'finished', homeScore: 0, awayScore: 1 },
  { id: 'bra-hai-2', date: '2026-06-20', tournament: '2026 FIFA World Cup', group: 'C组', round: '第二轮', matchday: 8, homeTeam: 'Brazil', awayTeam: 'Haiti', venue: 'Lincoln Financial Field, Philadelphia', kickoff: '6/20 09:00', localKickoff: '6/19 21:00', localTZ: 'ET', status: 'finished', homeScore: 3, awayScore: 0 },
  { id: 'tur-par-2', date: '2026-06-20', tournament: '2026 FIFA World Cup', group: 'D组', round: '第二轮', matchday: 8, homeTeam: 'Turkiye', awayTeam: 'Paraguay', venue: 'Levi Stadium, Santa Clara', kickoff: '6/20 12:00', localKickoff: '6/19 21:00', localTZ: 'PT', status: 'finished', homeScore: 0, awayScore: 1 },
  // ---- 6/21 MD10 已完赛（北京时间）----
  { id: 'ned-swe-2', date: '2026-06-21', tournament: '2026 FIFA World Cup', group: 'F组', round: '第二轮', matchday: 9, homeTeam: 'Netherlands', awayTeam: 'Sweden', venue: 'NRG Stadium, Houston', kickoff: '6/21 01:00', localKickoff: '6/20 12:00', localTZ: 'CT', status: 'finished', homeScore: 5, awayScore: 1 },
  { id: 'ger-civ-2', date: '2026-06-21', tournament: '2026 FIFA World Cup', group: 'E组', round: '第二轮', matchday: 9, homeTeam: 'Germany', awayTeam: 'Ivory Coast', venue: 'BMO Field, Toronto', kickoff: '6/21 04:00', localKickoff: '6/20 16:00', localTZ: 'ET', status: 'finished', homeScore: 2, awayScore: 1 },
  { id: 'ecu-cuw-2', date: '2026-06-21', tournament: '2026 FIFA World Cup', group: 'E组', round: '第二轮', matchday: 9, homeTeam: 'Ecuador', awayTeam: 'Curacao', venue: 'Arrowhead Stadium, Kansas City', kickoff: '6/21 08:00', localKickoff: '6/20 19:00', localTZ: 'CT', status: 'finished', homeScore: 0, awayScore: 0 },
  { id: 'tun-jpn-2', date: '2026-06-21', tournament: '2026 FIFA World Cup', group: 'F组', round: '第二轮', matchday: 9, homeTeam: 'Tunisia', awayTeam: 'Japan', venue: 'Estadio BBVA, Monterrey', kickoff: '6/21 12:00', localKickoff: '6/20 23:00', localTZ: 'CT', status: 'finished', homeScore: 0, awayScore: 4 },
  // ---- 6/22 第二轮（北京时间）----
  { id: 'esp-ksa-2', date: '2026-06-22', tournament: '2026 FIFA World Cup', group: 'H组', round: '第二轮', matchday: 10, homeTeam: 'Spain', awayTeam: 'Saudi Arabia', venue: 'Mercedes-Benz Stadium, Atlanta', kickoff: '6/22 00:00', localKickoff: '6/21 12:00', localTZ: 'ET', status: 'upcoming' },
  { id: 'bel-irn-2', date: '2026-06-22', tournament: '2026 FIFA World Cup', group: 'G组', round: '第二轮', matchday: 10, homeTeam: 'Belgium', awayTeam: 'Iran', venue: 'SoFi Stadium, Inglewood', kickoff: '6/22 03:00', localKickoff: '6/21 12:00', localTZ: 'PT', status: 'upcoming' },
  { id: 'uru-cpv-2', date: '2026-06-22', tournament: '2026 FIFA World Cup', group: 'H组', round: '第二轮', matchday: 10, homeTeam: 'Uruguay', awayTeam: 'Cape Verde', venue: 'Hard Rock Stadium, Miami', kickoff: '6/22 06:00', localKickoff: '6/21 18:00', localTZ: 'ET', status: 'upcoming' },
  { id: 'nzl-egy-2', date: '2026-06-22', tournament: '2026 FIFA World Cup', group: 'G组', round: '第二轮', matchday: 10, homeTeam: 'New Zealand', awayTeam: 'Egypt', venue: 'BC Place, Vancouver', kickoff: '6/22 09:00', localKickoff: '6/21 18:00', localTZ: 'PT', status: 'upcoming' },
  // ---- 6/23 第二轮（北京时间）----
  { id: 'arg-aut-2', date: '2026-06-23', tournament: '2026 FIFA World Cup', group: 'J组', round: '第二轮', matchday: 11, homeTeam: 'Argentina', awayTeam: 'Austria', venue: 'AT&T Stadium, Arlington', kickoff: '6/23 01:00', localKickoff: '6/22 12:00', localTZ: 'CT', status: 'upcoming' },
  { id: 'fra-irq-2', date: '2026-06-23', tournament: '2026 FIFA World Cup', group: 'I组', round: '第二轮', matchday: 11, homeTeam: 'France', awayTeam: 'Iraq', venue: 'Lincoln Financial Field, Philadelphia', kickoff: '6/23 05:00', localKickoff: '6/22 17:00', localTZ: 'ET', status: 'upcoming' },
  { id: 'nor-sen-2', date: '2026-06-23', tournament: '2026 FIFA World Cup', group: 'I组', round: '第二轮', matchday: 11, homeTeam: 'Norway', awayTeam: 'Senegal', venue: 'MetLife Stadium, East Rutherford', kickoff: '6/23 08:00', localKickoff: '6/22 20:00', localTZ: 'ET', status: 'upcoming' },
  { id: 'jor-alg-2', date: '2026-06-23', tournament: '2026 FIFA World Cup', group: 'J组', round: '第二轮', matchday: 11, homeTeam: 'Jordan', awayTeam: 'Algeria', venue: 'Levi Stadium, Santa Clara', kickoff: '6/23 11:00', localKickoff: '6/22 20:00', localTZ: 'PT', status: 'upcoming' },
];
...
export const predictions: Record<string, Prediction> = {
  ...
  'esp-ksa-2': {
    ...
    top5Scores: [{score:'2:0',probability:0.22,quadrant:'Q1'},{score:'3:0',probability:0.18,quadrant:'Q1'},{score:'1:0',probability:0.15,quadrant:'Q1'},{score:'0:0',probability:0.10,quadrant:'Q2'},{score:'4:0',probability:0.08,quadrant:'Q1'}],
  ...
  'bel-irn-2': {
    ...
    top5Scores: [{score:'2:0',probability:0.18,quadrant:'Q1'},{score:'1:0',probability:0.15,quadrant:'Q1'},{score:'1:1',probability:0.14,quadrant:'Q2'},{score:'3:0',probability:0.10,quadrant:'Q1'},{score:'0:0',probability:0.08,quadrant:'Q2'}],
    riskWarnings: ['伊朗5-3-2低block→可能复制佛得角策略', '比利时R1 1:1埃及低于预期', 'De Bruyne是破局关键'],
    quadrant: 'Q1', quadrantLabel: '强队碾压',
  },
  'uru-cpv-2': {
    ...
    top5Scores: [{score:'2:0',probability:0.16,quadrant:'Q1'},{score:'1:0',probability:0.15,quadrant:'Q1'},{score:'0:0',probability:0.13,quadrant:'Q2'},{score:'1:1',probability:0.10,quadrant:'Q2'},{score:'3:0',probability:0.08,quadrant:'Q1'}],
    riskWarnings: ['佛得角0:0逼平西班牙→防守能力远超ELO暗示', '乌拉圭R1 1:1沙特表现平平', '非洲球队世界杯加成+100 ELO'],
    quadrant: 'Q1', quadrantLabel: '强队碾压',
  },
  'nzl-egy-2': {
    ...
    top5Scores: [{score:'0:2',probability:0.20,quadrant:'Q1'},{score:'0:1',probability:0.16,quadrant:'Q1'},{score:'1:2',probability:0.12,quadrant:'Q1'},{score:'0:3',probability:0.10,quadrant:'Q1'},{score:'1:1',probability:0.10,quadrant:'Q2'}],
    riskWarnings: ['埃及预选赛6场0失球→防守铁壁', 'Salah+Marmoush攻击群', 'NZ Elijah Just R1 2球→有反击威胁'],
    quadrant: 'Q1', quadrantLabel: '强队碾压',
  },
  // ---- 6/23 第二轮 ----
  'arg-aut-2': {
...
export const keyLearnings = [
  '首轮平局率9/24=38%，第二轮平局率2/8=25%（显著下降，回归常态）',
  '强队赔率<1.50时平局溢价1.4x仍有效（西班牙、巴西、比利时、葡萄牙均平局）',
  '6/20四场全部分出胜负，第二轮非平局趋势延续（7/8=87.5%非平局）',
  '首轮惨败队伍第二轮反弹严重低估：巴拉圭1:4→1:0土耳其，需新增士气逆转因子',
  '6/20预测3/4方向+3/4比分精准，累计方向10/20=50%，比分TOP1 4/20=20%',
  ...
  '土耳其0:1巴拉圭揭示：首轮惨败(失球≥3)队伍第二轮反弹溢价上调至1.3x',
];
